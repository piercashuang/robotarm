...
public class keyboards : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        btn2.onClick.AddListener(() => { print("btn1"); input("2"); });
        btn3.onClick.AddListener(() => { print("btn1"); input("3"); });
        btn4.onClick.AddListener(() => { print("btn1"); input("4"); });
        btn5.onClick.AddListener(() => { print("btn1"); input("5"); });
        btn6.onClick.AddListener(() => { print("btn1"); input("6"); });
        btn7.onClick.AddListener(() => { print("btn1"); input("7"); });
        btn8.onClick.AddListener(() => { print("btn1"); input("8"); });
        btn9.onClick.AddListener(() => { print("btn1"); input("9"); });
        btn0.onClick.AddListener(() => { print("btn1"); input("0"); });
